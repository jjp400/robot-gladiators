...
var fightOrSkip = function() {
    // ask player if they'd like to fight or skip using fightOrSkip fcn
    ...
    // alternative using falsy values:
        // if (!promptFight) {
//             window.alert("You need to provide a valid answer! Please try again.");
//             return fightOrSkip
// }
...
var fight = function(enemy) {
    ...
    while(enemy.health > 0 && playerInfo.health > 0 ) {
        ...
        if (enemy.health <= 0) {
            ...
            // remove player's health by subtracting the value of 'enemy.attack' from the value of 'playerInfo.health'
            // generate random damage value based on player's attack power
...
// var to generate a random numeric value
